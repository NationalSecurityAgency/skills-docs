...
| isSummaryOnly         | boolean | false          | When enabled display renders overall summary only. This mode is not interactive, it provides user's progress preview that can be displayed on a landing page. |   
