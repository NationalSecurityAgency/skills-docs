...
| tiles.subTitleOverlayBackgroundColor   | Background color for the semi-transparent overlay on `My Rank` and `My Badges` cards. Use `rgba` format with alpha parameter, e.g., `rgba(243,198,54,0.3)`. Use with `subTitleOverlayTextColor`.                                      |
| tiles.subTitleOverlayTextColor         | Text color for the overlay on `My Rank` and `My Badges` cards. Use with `subTitleOverlayBackgroundColor`.                                                                                                                             |
