...
| totalPointsEarned            | *number*  | total points earned by this user for this skill                                                                                                                                                                                                                                                                                                                               |
| totalPoints                  | *number*  | total points defined by an administrator for this skill                                                                                                                                                                                                                                                                                                                       |
| numOccurrencesToCompletion   | *number*  | number of times skill needs to be performed to earn all its points                                                                                                                                                                                                                                                                                                            |
