...
There are number of different issues that are captured here. One example includes capturing attempts to report a Skill that doesn't exist in a Project. This commonly occurs when a typo has been made
